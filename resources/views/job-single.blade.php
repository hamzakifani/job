            ...
            <div class="p-5 bg-white">
              ...
              <div class="mb-4 mb-md-5 mr-5">
               ...
               <div class="job-post-item-body d-block d-md-flex">
                 <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span> <a href="#">{{$user->company}}</a></div>
              ...
              <p class="mt-5"><a href="{{('/job/'.$job->id.'/postuler')}}" class="btn btn-primary  py-2 px-4">Postuler</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-5">
            ...
            <div class="p-4 mb-3 bg-white">
                ...
                <div class="p-4 mb-3 bg-white">
                  ...
                  <p>{{$user->info}}</p>
                  <p><a href="{{('/company/'.$user->company)}}" class="btn btn-primary  py-2 px-4">Learn More</a></p>
                </div>
            </div>
          </div>
        </div>
